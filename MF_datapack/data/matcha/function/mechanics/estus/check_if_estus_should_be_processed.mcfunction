execute at @a run advancement revoke @p only matcha:mechanics/estus_obtained
execute if entity @p[gamemode=!creative] run function matcha:mechanics/estus/process_estus
