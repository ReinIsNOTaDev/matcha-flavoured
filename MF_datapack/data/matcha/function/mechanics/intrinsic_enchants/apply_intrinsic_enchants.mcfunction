...
execute if items entity @s container.* *[minecraft:custom_data~{"has_intrinsic_enchants": 1b}] run function matcha:mechanics/intrinsic_enchants/process_intrinsic_enchants
