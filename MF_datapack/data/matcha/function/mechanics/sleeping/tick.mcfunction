...
function matcha:mechanics/sleeping/add_variable_time with storage sleep_rate_temp

# update sleeping players' sleep duration and check that they are still asleep.
execute as @a[tag=is_sleeping] run function matcha:mechanics/sleeping/tick_sleeping_player
