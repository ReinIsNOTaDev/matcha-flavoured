...
item modify entity @s weapon.mainhand {'function': 'set_components', 'components': {'minecraft:max_damage': 5000, 'minecraft:tool': {'rules': [{'blocks': '#minecraft:mineable/axe', 'speed': 15, 'correct_for_drops': True}], 'default_mining_speed': 1, 'damage_per_block': 1}, 'minecraft:custom_data': {'has_intrinsic_enchants': 1, 'version': 1}, 'minecraft:lore': [{'translate': 'desc.kleispack.mining_speed', 'with': [{'text': '15'}], 'color': 'blue', 'italic': False}, {'translate': 'desc.kleispack.attack_damage', 'with': [{'text': '10'}], 'color': 'dark_green', 'italic': False}, {'translate': 'desc.kleispack.cooldown', 'with': [{'text': '1'}], 'color': 'dark_green', 'italic': False}, {'translate': 'desc.kleispack.repaired_with', 'color': 'gray', 'italic': False}, {'translate': 'block.minecraft.diamond_block', 'color': 'dark_gray', 'italic': False}, {'translate': 'item.minecraft.netherite_scrap', 'color': 'dark_gray', 'italic': False}], 'minecraft:tooltip_display': {'hidden_components': ['minecraft:attribute_modifiers']}, 'minecraft:repairable': {'items': ['minecraft:diamond_block', 'minecraft:netherite_scrap']}, 'minecraft:item_name': {'translate': 'item.minecraft.netherite_axe', 'color': 'gold'}}}function matcha_item:enchants/mainhand/adamant_axe with matcha_item:enchantsfunction matcha_item:enchants/offhand/adamant_axe with matcha_item:enchants