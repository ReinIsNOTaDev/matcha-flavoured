say <D> Updating mainhand for adamant_pickaxe
data modify storage matcha_item:enchants held set from entity @s SelectedItem.components.minecraft:enchantments
item modify entity @s weapon.mainhand matcha_item:modify/adamant_pickaxe# processing enchantment minecraft:efficiency / efficiency 
