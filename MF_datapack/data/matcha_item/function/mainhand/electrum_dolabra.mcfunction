say <D> Updating mainhand for electrum_dolabra
data modify storage matcha_item:enchants held set from entity @s SelectedItem.components.minecraft:enchantments
item modify entity @s weapon.mainhand matcha_item:modify/electrum_dolabra# processing enchantment matcha:electrum_tool / electrum_tool 
