...
# processing enchantment matcha:warding_3
execute store result score enchantsLvl matcha:warding_3 run data get matcha_item:enchants held.matcha:warding_3
execute unless score enchantsLvl matcha:warding_3 matches 1.. run data merge storage matcha_item:enchants held {matcha:warding_3:1}
