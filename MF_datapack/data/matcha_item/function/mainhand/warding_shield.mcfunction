say <D> Updating mainhand for warding_shield
data modify storage matcha_item:enchants held set from entity @s SelectedItem.components.minecraft:enchantments
item modify entity @s weapon.mainhand matcha_item:modify/warding_shield# processing enchantment matcha:warding_1 / warding_1 
