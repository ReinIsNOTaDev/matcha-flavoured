...
item modify entity @s weapon.offhand {'function': 'set_components', 'components': {'minecraft:max_damage': 5000, 'minecraft:item_name': {'translate': 'item.minecraft.netherite_spear', 'color': 'gold'}, 'minecraft:lore': [{'translate': 'desc.kleispack.attack_damage', 'with': [{'text': '4'}], 'color': 'dark_green', 'italic': False}, {'translate': 'desc.kleispack.cooldown', 'with': [{'text': '0.95'}], 'color': 'dark_green', 'italic': False}, {'translate': 'desc.kleispack.repaired_with', 'color': 'gray', 'italic': False}, {'translate': 'block.minecraft.diamond_block', 'color': 'dark_gray', 'italic': False}, {'translate': 'item.minecraft.netherite_scrap', 'color': 'dark_gray', 'italic': False}], 'minecraft:tooltip_display': {'hidden_components': ['minecraft:attribute_modifiers']}, 'minecraft:repairable': {'items': ['minecraft:diamond_block', 'minecraft:netherite_scrap']}, 'minecraft:enchantment_glint_override': False, 'minecraft:custom_data': {'has_intrinsic_enchants': 1, 'version': 1}}}
