say <D> Updating offhand for electrum_shovel
data modify storage matcha_item:enchants held set from entity @s equipment.offhand.components.minecraft:enchantments
item modify entity @s weapon.offhand matcha_item:modify/electrum_shovel# processing enchantment matcha:electrum_tool / electrum_tool 
