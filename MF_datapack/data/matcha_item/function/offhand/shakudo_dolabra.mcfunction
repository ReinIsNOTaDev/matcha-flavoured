say <D> Updating offhand for shakudo_dolabra
data modify storage matcha_item:enchants held set from entity @s equipment.offhand.components.minecraft:enchantments
item modify entity @s weapon.offhand matcha_item:modify/shakudo_dolabra# processing enchantment minecraft:silk_touch / silk_touch 
