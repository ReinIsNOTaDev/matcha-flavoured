say <D> Updating offhand for shakudo_mattock
data modify storage matcha_item:enchants held set from entity @s equipment.offhand.components.minecraft:enchantments
item modify entity @s weapon.offhand matcha_item:modify/shakudo_mattock# processing enchantment minecraft:silk_touch / silk_touch 
