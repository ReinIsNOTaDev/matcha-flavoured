say <D> Updating offhand for warding_sword
data modify storage matcha_item:enchants held set from entity @s equipment.offhand.components.minecraft:enchantments
item modify entity @s weapon.offhand matcha_item:modify/warding_sword# processing enchantment matcha:warding_1 / warding_1 
