...
execute as @a run execute unless score @s version_number >= zero version_number run scoreboard players set @s version_number 0

#If the player's version number < current, add them to the scoreboard
execute as @a run execute if score @s version_number < current_version version_number run function main:setup/scoreboard
...
execute as @a run execute if score @s version_number < current_version version_number run function main:setup/revoke_all_recipe_unlock_advancements
