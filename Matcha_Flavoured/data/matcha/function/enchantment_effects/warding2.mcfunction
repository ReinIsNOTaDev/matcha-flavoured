...
execute at @n[type=#matcha:warding_targets,type=!wither,predicate=!matcha:wearing_copper_armour,distance=..14] run particle minecraft:soul_fire_flame ~ ~1.5 ~ .1 .3 .1 .02 1
