...
function matcha:mechanic/intrinsic_enchants/select_higher_level {"enchantment_id": "matcha:warding0"}
function matcha:mechanic/intrinsic_enchants/select_higher_level {"enchantment_id": "matcha:warding1"}
