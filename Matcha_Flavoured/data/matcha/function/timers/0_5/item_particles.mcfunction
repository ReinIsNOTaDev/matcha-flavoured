...
execute at @e[type=item,tag=particle_checked,tag=particle_nether_star] run function matcha:timers/0_5/item_particles_functions/item_particles_nether_star
