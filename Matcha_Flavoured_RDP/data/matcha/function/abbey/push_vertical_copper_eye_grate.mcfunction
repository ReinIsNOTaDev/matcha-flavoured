execute at @a[advancements={matcha:mechanics/hit_copper_eye=true}] run playsound minecraft:block.enchantment_table.use block @p ~ ~ ~ 1 2
...
execute at @n[type=marker] run function matcha:abbey/kill_copper_eye