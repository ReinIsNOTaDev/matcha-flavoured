...
execute unless entity @e[distance=..20,predicate=matcha:effects/has_weakness,predicate=matcha:has_adamant] run return fail
...
execute as @e[distance=..20,predicate=matcha:effects/has_weakness,predicate=matcha:has_adamant] run function matcha:enchantment_effects/adamant_effects/apply_doom_3
