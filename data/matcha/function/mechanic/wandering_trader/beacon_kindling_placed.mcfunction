...
execute if entity @s[tag=SummonedTrader] run execute as @s run function matcha:mechanic/wandering_trader/kill_this_beacon
execute if entity @s[tag=!SummonedTrader] run execute as @s run function matcha:mechanic/wandering_trader/initialise_wandering_trader_spawn
